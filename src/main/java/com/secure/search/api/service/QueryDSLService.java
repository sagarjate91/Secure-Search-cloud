package com.secure.search.api.service;
...
public class QueryDSLService {
	...
	public List<Customer> searchMultiField(String firstname, int age) {
		QueryBuilder query = QueryBuilders.boolQuery().must(QueryBuilders.matchQuery("firstname", firstname.toLowerCase()))
	...
	public List<Customer> multiMatchQuery(String text) {
		SearchQuery searchQuery = new NativeSearchQueryBuilder().withQuery(QueryBuilders.multiMatchQuery(text.toLowerCase())
